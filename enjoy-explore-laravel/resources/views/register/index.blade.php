                ...
                <div class="col-md-6 px-182 my-auto">
                    ...
                    <form action="/register" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password" class="form-control  @error('password') is-invalid @enderror border-radius-none h-40 fs-14px" id="password" placeholder="Password" required value={{ old('pass') }}>
                            @error('password')
                            <div class="invalid-feedback">
                                {{ $message }}
                              </div>
