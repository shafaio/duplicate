            ...
            <div class="row mt-84">
                ...
                <div class="col-9">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-9">
                            <div class="form-group">
                                <input type="email" class="form-control border-radius-none h-40 fs-14px baybay" id="inputName" aria-describedby="emailHelp" placeholder="Email">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-9">
                            <div class="form-group">
                                <input type="text" class="form-control border-radius-none h-40 fs-14px baybay" id="inputName" aria-describedby="emailHelp" placeholder="Password">
                            </div>
                        </div>
                    </div>
                    <div class="row mb-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-9">
                            <div class="form-group">
                                <input type="text" class="form-control border-radius-none h-40 fs-14px baybay" id="inputName" aria-describedby="emailHelp" placeholder="Nomer Telepon">
                            </div>
                        </div>
                    </div>
                    <div class="row mb-4">
                        ...
                        <div class="col-9">
                            <div class="form-group">
                                <input type="text" class="form-control border-radius-none h-40 fs-14px baybay" id="inputName" aria-describedby="emailHelp" placeholder="Alamat">
                            </div>
                        </div>
                    </div>
                </div>
