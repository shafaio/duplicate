...
<body>
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item mr-3 fs-7">
                        <a class="nav-link color-2323" href="index.html">Beranda <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item mr-3 fs-7 active">
                        <a class="nav-link color-2323" href="#">Pariwisata</a>
                    </li>
                    <li class="nav-item mr-3 fs-7">
                        <a class="nav-link color-2323" href="#">Tentang Kami</a>
                    </li>
                </ul>
            </div>
            <div class="dropdown">
    ...
    <section>
        <div class="container mt-230">
            <div class="col-6">
                <h2 class="mb-3">Explore Lombok</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia soluta sequi provident, magni voluptatibus ullam facere asperiores maiores, maxime, eligendi explicabo libero dicta debitis officiis obcaecati modi sint distinctio unde?</p>
                <br>
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Labore nemo distinctio amet modi laboriosam laudantium impedit, eum corrupti repellendus cupiditate? Lorem ipsum dolor sit amet consectetur adipisicing elit. Est accusamus natus
                    possimus.
                </p>
                <form class="d-flex ">
...
<?php /**PATH D:\Aplication\enjoyexplore\enjoy-explore-laravel\resources\views/pariwisata/index.blade.php ENDPATH**/ ?>