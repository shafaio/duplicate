                ...
                <div class="col-md-6 px-182 my-auto">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control border-radius-none h-40 fs-14px" id="inputUsername" placeholder="Username">
                        </div>
                        <div class="form-group">
                            <label for="inputEmail">Email</label>
                            <input type="email" class="form-control border-radius-none h-40 fs-14px" id="inputEmail" aria-describedby="emailHelp" placeholder="Email">
                        </div>
                        <div class="form-group">
                            <label for="inputPassword">Password</label>
                            <input type="password" class="form-control border-radius-none h-40 fs-14px" id="inputPassword" placeholder="Password">
                        </div>
                        <div class="form-group">
                            <label for="confirmPassword">Confirm Password</label>
                            <input type="password" class="form-control border-radius-none h-40 fs-14px" id="confirmPassword" placeholder="Confirm Password">
                        </div>
...
</html><?php /**PATH D:\Aplication\my-laravel\resources\views/daftar.blade.php ENDPATH**/ ?>